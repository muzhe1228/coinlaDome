...
import TopUpAlert from "../TopUp";
import WithdrawalAlert from "../Withdrawal";
import HomeRuleAlert from "../HomeRule";
  ...
  selectType(type) {
    switch (type) {
      ...
      case "WithdrawalAlert":
        return <WithdrawalAlert onClose={this.close}/>;
      case "ExchangeCoin":
        return <ExchangeCoin onClose={this.close}/>;
      case "HomeRuleAlert":
        return <HomeRuleAlert/>;
      default:
        return;
    }
  }
